                                                        ...
                                                        <div class="owl-carousel owl-theme auth-review-carousel"
                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    ...
                                                                    <div>
                                                                        <h4 class="font-size-16 text-primary">Abs</h4>
                                                                        <p class="font-size-14 mb-0">- Aero</p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    ...
                                                                    <div>
                                                                        <h4 class="font-size-16 text-primary">neze</h4>
                                                                        <p class="font-size-14 mb-0">- Aero</p>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">Re-Password with Aero.</p>
                                        </div>
